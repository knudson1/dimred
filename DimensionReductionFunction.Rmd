---
title: "Dimension Reduction Function"
author:"Zachary F, Clare Hillmer,  Adit Jain"
output: html_document
---

```{r}
# Libraries used  for function
library(glmm)
library(plyr)
library(dbplyr)
```
...
```
```{r}
# Testing on salamander data with regression stored in sal
levels(ReduceDim(salamander$Female,sal$u.pql[1:60]))
```
